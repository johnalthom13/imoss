...
public class InitSettingsDialog extends JDialog
{
	...
	private InitSettingsDialog()
	{
		...
		add(createTimeDelaySelectorPanel());
	...
	private Component createTimeDelaySelectorPanel()
	{
		...
		timeDelaySelector_ = new JComboBox<>(sizeModel);
		JLabel label = new JLabel("Time Delay (ms): ");
		
		panel.add(timeDelaySelector_, BorderLayout.EAST);
	...
	private void prepareSubmitButton()
	{
		...
		submitButton_.addActionListener(new ActionListener()
		{
			...
			{
				ConfigData.ANIMATION_DELAY = (Integer) timeDelaySelector_.getSelectedItem();
	...
	private JComboBox<Integer> timeDelaySelector_;
